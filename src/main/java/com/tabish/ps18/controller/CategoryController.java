    ...
    @Operation(
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    content = @Content(examples = @ExampleObject(
                            ...
                            value = "{\"name\": \"Electronics\", \"description\": \"Electronic devices and accessories\", \"active\": true}"
                    ))
            )
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    content = @Content(examples = @ExampleObject(
                            ...
                            value = "{\"name\": \"Consumer Electronics\", \"description\": \"Updated description for consumer electronics\", \"active\": true}"
                    ))
            )
    )
    @ApiResponses({
