...
public class ProductController {
    ...
    @Operation(
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    content = @Content(examples = @ExampleObject(
                            name = "Create Product",
                            value = "{\"name\": \"iPhone 15 Pro\", \"description\": \"Latest Apple smartphone with A17 Pro chip\", \"price\": 999.99, \"stockQuantity\": 50, \"sku\": \"APL-IPH15P-256\", \"available\": true, \"category\": {\"id\": 1}}"
                    ))
            )
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    content = @Content(examples = @ExampleObject(
                            name = "Update Product",
                            value = "{\"name\": \"iPhone 15 Pro Max\", \"description\": \"Updated description\", \"price\": 1199.99, \"stockQuantity\": 30, \"sku\": \"APL-IPH15PM-256\", \"available\": true, \"category\": {\"id\": 1}}"
                    ))
            )
    )
    @ApiResponses({
